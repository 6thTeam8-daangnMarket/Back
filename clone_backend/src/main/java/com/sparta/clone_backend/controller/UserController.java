...
//        statusMessage.setData(signupRequestDto);
...
//            statusMessage.setStatus(StatusMessage.StatusEnum.BAD_REQUEST);
    ...
    private ResponseEntity<String> userDupliChk(@RequestBody DuplicateChkDto duplicateChkDto){
    ...
    private ResponseEntity<String> nickNameDupliChk(@RequestBody DuplicateChkDto duplicateChkDto){
